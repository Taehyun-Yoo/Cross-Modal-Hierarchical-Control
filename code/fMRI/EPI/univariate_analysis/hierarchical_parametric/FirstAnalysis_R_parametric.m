...
for s = 1:length(subjects) 
    ...
    if exist(strcat(subj_dir, '/analysis/parametric_analysis_2_-inf/R_parametric/SPM.mat'), 'file') == 2
       delete(strcat(subj_dir, '/analysis/parametric_analysis_2_-inf/R_parametric/*'))
    end
    
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% 
    
        
    matlabbatch{1}.spm.stats.fmri_spec.dir = {fullfile(subj_dir, 'analysis/parametric_analysis_2_-inf/R_parametric')};
    ...
    matlabbatch{2}.spm.stats.fmri_est.spmmat = {fullfile(subj_dir, 'analysis/parametric_analysis_2_-inf/R_parametric', 'SPM.mat')};
    ...
    matlabbatch{3}.spm.stats.con.spmmat = {fullfile(subj_dir, 'analysis/parametric_analysis_2_-inf/R_parametric', 'SPM.mat')};
