...
%     for h = 1:length(hier)
%         pm_image_masked{s}{h} = strcat(project_dir, 'analysis/', subjects{s}, '/analysis/parametric_analysis_2_-inf/', hier{h}, '_parametric/spmT_0001_masked.nii');   
%         pm_image_binary{s}{h} = strcat(project_dir, 'analysis/', subjects{s}, '/analysis/parametric_analysis_2_-inf/', hier{h}, '_parametric/spmT_0001_binary_mask.nii');   
%         pm_image_cluster{s}{h} = strcat(project_dir, 'analysis/', subjects{s}, '/analysis/parametric_analysis_2_-inf/', hier{h}, '_parametric/spmT_0001_global_cluster.nii');
%     end
% end
...
for s = 1:length(sub_number)
    for h = 1:length(hier)
        ...
        matlabbatch = {};
        matlabbatch{1}.spm.stats.results.spmmat = {strcat(project_dir, 'analysis/', subjects{s}, '/analysis/parametric_analysis_2_-inf/', hier{h}, '_parametric/SPM.mat')};
