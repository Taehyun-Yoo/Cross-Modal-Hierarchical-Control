...
c3idx=example(:,4)==3;
%p.LineWidth = 3;
plot3(example(c1idx,1), example(c1idx,2),example(c1idx,3),'s', 'MarkerSize', 13, 'Color', '#676767', 'MarkerFaceColor','#2B6A6C');
hold on
%plot3(example(c1idx,1),example(c1idx,2),example(c1idx,3),' x', 'Color', '#8B488F');
%hold on
plot3(example(c2idx,1), example(c2idx,2),example(c2idx,3),'s', 'MarkerSize', 13, 'Color', '#676767', 'MarkerFaceColor','#F29724');
hold on
%plot3(example(c2idx,1),example(c2idx,2),example(c2idx,3),' x', 'Color', '#E6E007');
%hold on
plot3(example(c3idx,1), example(c3idx,2),example(c3idx,3),'s', 'MarkerSize', 13, 'Color', '#676767', 'MarkerFaceColor','#B80D48');
hold on
grid on;
