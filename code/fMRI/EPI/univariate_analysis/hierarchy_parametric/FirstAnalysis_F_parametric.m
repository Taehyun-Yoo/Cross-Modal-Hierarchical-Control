...
cont_w = [zeros(1,1), 1, zeros(1,6), zeros(1,1), 1, zeros(1,6), zeros(1,1), 1, zeros(1,6), zeros(1,1), 1, zeros(1,6), zeros(1,4)];
...
for s = 1:length(subjects) 
    ...
    if exist(strcat(subj_dir, '/analysis/parametric_analysis/F_parametric/SPM.mat'), 'file') == 2
       delete(strcat(subj_dir, '/analysis/parametric_analysis/F_parametric/*'))
    end
    
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% 
    
        
    matlabbatch{1}.spm.stats.fmri_spec.dir = {fullfile(subj_dir, 'analysis/parametric_analysis/F_parametric')};
    ...
    for r = 1:run_num
        ...
        matlabbatch{1}.spm.stats.fmri_spec.sess(r).cond.pmod.param = [1; 1; 2; 2; 4; 4];
    ...
    matlabbatch{2}.spm.stats.fmri_est.spmmat = {fullfile(subj_dir, 'analysis/parametric_analysis/F_parametric', 'SPM.mat')};
    ...
    matlabbatch{3}.spm.stats.con.spmmat = {fullfile(subj_dir, 'analysis/parametric_analysis/F_parametric', 'SPM.mat')};
