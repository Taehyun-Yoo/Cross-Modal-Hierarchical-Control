...
result_dir <- paste0(dir, 'results_2nd/ROI_analysis_2/ROI_2voxels/')
#result_dir <- paste0(dir, 'results_2nd/ROI_analysis/badre_ROI_2voxels/')
...
for (i in 1:length(sub)) {
  sub_dir <- paste0(dir, 'sub', sub[i], '/analysis/ROI_analysis_2/')
