...
outDir = strcat(project_dir, 'Code/EPI/univariate_analysis/ROI/Prerequisite_2');
%radius = 6; % mm
...
% 
%     outName = fullfile(outDir, strcat(char(roi_label(pt_no)), '_roi_2voxels'));
%     saveroi(roi, [outName '.mat']);
% end

roi_namearray = dir(fullfile(outDir, '*_2voxels_roi.mat'));
