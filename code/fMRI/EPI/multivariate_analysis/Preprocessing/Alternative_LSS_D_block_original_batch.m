function Alternative_LSS_D_block_original_batch(s)
    ...
    for r = 1:run_num
        ...
        % load txt file
            fid = fopen(strcat(project_dir, 'RAW/main/behavioral_data/Onset/', subjects{s}, '/', num2str(r+6), '_D2_', condition_name{c}, '.txt'), 'rt');
    ...
    for r = 1:run_num
        for c = 1:length(condition_name)
        % load txt file
            fid = fopen(strcat(project_dir, 'RAW/main/behavioral_data/Onset/', subjects{s}, '/', num2str(r+6), '_D2_', condition_name{c}, '_RT.txt'), 'rt');
    ...
    for r = 1:run_num
        for c = 1:length(condition_name)
        % load txt file
            fid = fopen(strcat(project_dir, 'RAW/main/behavioral_data/Onset/', subjects{s}, '/', num2str(r+6), '_D2_', condition_name{c}, '_Block.txt'), 'rt');
    ...
    for r = 1:run_num
        fid = fopen(strcat(project_dir, 'RAW/main/behavioral_data/Onset/', subjects{s}, '/', num2str(r+6), '_D2_', '1234.txt'), 'rt');
    ...
    for r = 1:run_num        
        for c = 1:condition_num
            ...
            for k = 1:correct_num_sub_run_con{r}{c}
                if c == 1
                    trial_in{r}{c}{k} = [num2str(r) '_D2_1_' num2str(blocks{r}{c}(k)) '_' num2str(k)];
                elseif c == 2
                    trial_in{r}{c}{k} = [num2str(r) '_D2_2_' num2str(blocks{r}{c}(k)) '_' num2str(k)];
                elseif c == 3
                    trial_in{r}{c}{k} = [num2str(r) '_D2_3_' num2str(blocks{r}{c}(k)) '_' num2str(k)];
                else
                    trial_in{r}{c}{k} = [num2str(r) '_D2_4_' num2str(blocks{r}{c}(k)) '_' num2str(k)];
                end
